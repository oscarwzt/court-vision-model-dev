...
from ultralytics_.nn.autobackend import check_class_names, default_class_names
from ultralytics_.nn.modules import C2f, Detect, RTDETRDecoder
from ultralytics_.nn.tasks import DetectionModel, SegmentationModel
...
from ultralytics_.utils.checks import PYTHON_VERSION, check_imgsz, check_is_path_safe, check_requirements, check_version
from ultralytics_.utils.downloads import attempt_download_asset, get_github_assets
from ultralytics_.utils.files import file_size, spaces_in_path
from ultralytics_.utils.ops import Profile
from ultralytics_.utils.torch_utils import get_latest_opset, select_device, smart_inference_mode
